...
describe('home page load', () => {
    ...
    it('builds daily candidates from valid gallery posts', async () => {
        vi.mocked(fetchHomePosts).mockResolvedValue([
            makePost('1gkxrh2', { date: 10, nsfw: true }),
            makePost('another-post', { date: 20 }),
        ...
        await expect(load()).resolves.toEqual({
            dailyPostCandidates: [
                ...
                { id: 'another-post', img: 'https://example.com/another-post.jpg', nsfw: false, date: 20 },

import { i as import1 } from "../chunks/chunk-DfkNyCGY.js";
...
const Page = () => {
  useTheme();
  {
    return /* @__PURE__ */ jsxs("div", { style: { padding: "2rem", textAlign: "center" }, children: [
      /* @__PURE__ */ jsx(Typography, { variant: "h6", children: "Access Denied" }),
      /* @__PURE__ */ jsx(Typography, { children: "You don't have permission to access this page." })
    ] });
  }
};

...
const ProfileItem = ({ name, imageUrl, description, link }) => {
  const ImageContent = imageUrl ? /* @__PURE__ */ jsx(Avatar, { src: imageUrl, alt: name, sx: styles.avatar, variant: "rounded", slotProps: { img: { loading: "lazy", decoding: "async", fetchPriority: "low" } } }) : /* @__PURE__ */ jsx(Box, { sx: styles.placeholder, "aria-hidden": true });
  const handleClick = () => {
